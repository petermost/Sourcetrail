...
std::vector<LegacyVisualStudio::Version> LegacyVisualStudio::getVersions()
{
	const vector<Version> versions = {
		{ "Visual Studio 2015"s, "14.0"s },
		{ "Visual Studio 2013"s, "12.0"s },
		{ "Visual Studio 2012"s, "11.0"s },
		{ "Visual Studio 2010"s, "10.0"s }
	};
	return versions;
}
